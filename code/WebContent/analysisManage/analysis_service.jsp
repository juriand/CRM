    ...
    <div id="wrapper">
					...
					<li>
                        <a  class="active-menu-top" href="#"><i class="fa fa-bicycle "></i><s:text name="dataAnalysis"/><span class="fa arrow"></span></a>
                         <ul class="nav nav-second-level collapse in">
							...
							<li>
                                <a class="active-menu" href="analysisManage/analysis!service"><i class="fa fa-code "></i><s:text name="serAna"/></a>
                            </li>
                             <li>
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line"><s:text name="serAna"/></h1>
						...
						<form action="analysisManage/analysis!service" method="post">
                                ...
                                <table class="table table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th><s:text name="entry"/></th>
                                            <th><s:text name="serviceNum"/></th>
                                        </tr>
                                    </thead>
                                    <tbody>
