    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line"><s:text name="userManagement"/>  <a href="authorityManage/user!prepareAdd"><button class="btn btn-success"><i class="glyphicon glyphicon-plus"></i><s:text name="add"/></button></a></h1>
						<h1 class="page-subhead-line">
                            <ol class="breadcrumb">
							  <li><s:text name="authorityManagement"/></li>
							  <li class="active"><s:text name="userManagement"/></li>
							</ol>	
						</h1>
						
						<form class="input-group" action="authorityManage/user!list" method="post">
							<div class="form-group col-md-4">
                                <input name="user_id" class="form-control" type="text" placeholder="<s:text name="inputUser"/>">
                            </div>
                            
                            <div class="form-group col-md-4">
                                <input name="user_nickname" class="form-control" type="text" placeholder="<s:text name="inputNickname"/>">
                            </div>
							
							<div class="input-group col-md-4">
								<select name="user_role.role_id" class="form-control" type="text">
									<option value="0"><s:text name="chooseRole"/>..</option>
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <s:if test="users.size()!=0">
                                        	...
                                        	<tr class="tablelink" onclick="doLink('authorityManage/user!view?user_id=${user_id}');">
                                            	<td><s:property value="user_id"/></td>
                                            	<td><s:property value="user_nickname"/></td>
                                            	<td><s:property value="user_role.role_name"/></td>
                                            	<td><s:property value="user_email"/></td>
												<td>
													<s:if test="%{#session.user.user_role.role_id == \"1\"}">
													<a href="authorityManage/user!delete?user_id=${user_id}"><button class="btn btn-danger"><s:text name="delete"/></button></a>
													</s:if>
												</td>
                                        	</tr>
                                        	</s:iterator>
