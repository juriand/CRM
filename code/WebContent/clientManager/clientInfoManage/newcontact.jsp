            ...
            <div id="page-inner">
                ...
                <div class="row">
			        ...
			        <div class="panel panel-default">
						...
						<div class="row">
						<div class="col-md-12">
						<form class="" id="clienform" action="clientInfoManage/client!addContact" method="post">
							...
							<div class="form-group col-md-5">
								<label>性别</label>
								 <div class="radio">
									<label>
										<input type="radio" name="contact.contact_gender" id="male" value="男" checked="" >男
									</label>
									<label>
							...
							<div class="form-group col-md-5">
								<label>职位</label>
								<input id="position" name="contact.contact_position" class="form-control" type="text"   />
							</div>
							
							<div class="form-group col-md-5">
								<label>办公电话</label>
								<input id="officialtel" name="contact.contact_officephone" class="form-control" type="text" />
							</div>
							
							<div class="form-group col-md-5">
								<label>手机</label>
								<input id="phone" name="contact.contact_telephone" class="form-control" type="text"  />
							</div>
							
							<div class="form-group col-md-5">
								<label>备注</label>
								<input id="append" name="contact.contact_memo" class="form-control" type="text"  />
							</div>
