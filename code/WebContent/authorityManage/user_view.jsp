    ...
    <div id="wrapper">
					...
					<li>
                        <a href="#"><i class="fa fa-bicycle "></i><s:text name="authorityManagement"/><span class="fa arrow"></span></a>
                         <ul class="nav nav-second-level collapse in">
                             ...
                             <li>
                                <a class="active-menu" href="authorityManage/user!listAll"><i class="fa fa-desktop "></i><s:text name="userManagement"/></a>
                            </li>
                             <li>
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line"><s:text name="userManagement"/></h1>
						<ol class="breadcrumb">
							<li><s:text name="authorityManagement"/></a></li>
							<li><a href="authorityManage/user!listAll"><s:text name="userManagement"/></a></li>
							<li class="active"><s:text name="viewUser"/></li>
						</ol>
                ...
                <div class="row">
			        ...
			        <div class="panel panel-default">
						...
						<form id="userForm" action="authorityManage/user!update" method="post">	
							<div class="form-group col-md-5">
								<label><s:text name="id"/></label><span style="color:red;">  *</span>
								 <input id="id" name="user_id" class="form-control" type="text" required="required" value="${ user.user_id}" disabled="disabled"/>
							</div>
							<div class="form-group col-md-5">
								<label><s:text name="password"/></label><span style="color:red;">  *</span>
								<input id="pwd" name="user_password" class="form-control" type="text" required="required" value="${ user.user_password}" disabled="disabled"/>	
							</div>
							<div class="form-group col-md-5">
								<label><s:text name="nickname"/></label>
								 <input id="nickname" name="user_nickname" class="form-control" type="text" value="${ user.user_nickname}" disabled="disabled"/>
							</div>

							<div class="form-group col-md-5">
								<label><s:text name="role"/></label><span style="color:red;">  *</span>
								<select id="role" name="user_role.role_id" class="form-control" disabled="disabled">
									<s:iterator value="roles">
									<s:if test="user.user_role.role_id == role_id">
									<option value="${role_id }" selected="selected"><s:property value="role_name"/></option>
									</s:if>
									<s:else>
									<option value="${role_id }"><s:property value="role_name"/></option>
									</s:else>
									</s:iterator>
								</select>
							</div>
							<div class="form-group col-md-5">
								...
								<input id="email" name="user_email" class="form-control" type="email" value="${ user.user_email}" disabled="disabled"/>	
							</div>
						</form>
							<div class="form-group col-md-10">
								<button id="changeBtn" class="btn btn-danger" onclick="changeEditable();"><s:text name="modify"/></button>
								<button type="submit" id="submitBtn" form="userForm" class="btn btn-success" style="display:none"><s:text name="save"/></button>
