...
<head>
	...
	<script language="javascript">
		...
		window.location.href = "clientManager/clientInfoManage/contactinfo.jsp?contactid=" + contactid;
		}
	</script>
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
							...
							<div class="form-group col-md-2">
								<label>操作</label>
							    <a href="clientManager/clientInfoManage/newcontact.jsp">
							    <button id="newcontact" class="btn btn-success"><i class="glyphicon glyphicon-plus"></i>新建</button>
						        </a>
							</div>
                        </div>
                    </div>
                ...
                <div class="row">
					...
					<div class="panel-body">
					<s:if test="client.contacts.size==0||client==null">
                              <h3>没有联系人！</h3>
                    </s:if>
					<s:else>
				        <div class="table-responsive">
                             <table class="table table-hover">
                                 ...
                                 <tbody>
	                                 <s:iterator value="client.contacts" >
	                                     <tr class="tablelink" onclick="doLink(<s:property value="contact_id"/>);">
	                                        <td><s:property value="contact_name"/></td>
											<td><s:property value="contact_gender"/></td>
											<td><s:property value="contact_position"/></td>
											<td><s:property value="contact_officephone"/></td>
											<td><s:property value="contact_telephone"/></td>
											<td><s:property value="contact_memo"/></td>
	                                     </tr>
							         </s:iterator>
                                 </tbody>
                             </table>
