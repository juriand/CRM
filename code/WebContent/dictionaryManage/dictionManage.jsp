                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                    		<s:iterator value="#request.allDictions" var="dic">
                                    		<!-- 明天问去 -->
                                        	<tr class="tablelink" onclick="doLink('dictionManage/diction!view?dictionary_id=<s:property value="#dic.dictionary_id"/>');">
                                            	<td><s:property value="#dic.dictionary_id"/></td>
                                            	<td><s:property value="#dic.dictionary_type"/></td>
                                            	<td><s:property value="#dic.dictionary_entry"/></td>
                                            	<td><s:property value="#dic.dictionary_value"/></td>
												<td><s:property value="#dic.dictionary_editable"/></td>
												<td>
													<a href="saleManage/oppor!delete?oppo_id=${diction_id}"><button class="btn btn-danger"><i class="glyphicon glyphicon-home"></i>删除</button></a>
												</td>
                                        	</tr>
                                        	</s:iterator>
