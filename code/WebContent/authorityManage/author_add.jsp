            ...
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
						...
						<ol class="breadcrumb">
							...
							<li class="active"><s:text name="addAuthor"/></li>
						</ol>
                ...
                <div class="row">
			        ...
			        <div class="panel panel-default">
						...
						<form action="authorityManage/author!add" method="post">	
							<div class="form-group col-md-5">
								<label><s:text name="authorName"/></label><span style="color:red;">  *</span>
								 <input name="authority_name" class="form-control" type="text" required="required"/>
							</div>
