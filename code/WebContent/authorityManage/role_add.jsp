            ...
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
						...
						<ol class="breadcrumb">
							...
							<li class="active"><s:text name="addRole"/></li>
						</ol>
                ...
                <div class="row">
			        ...
			        <div class="panel panel-default">
						...
						<form id="roleForm" action="authorityManage/role!add" method="post">	
							<div class="form-group col-md-5">
								<label><s:text name="id"/></label><span style="color:red;">  *</span>
								 <input name="role_name" class="form-control" type="text" required="required" />
							</div>
							
							<div class="form-group col-md-12">
								<label><s:text name="roleName"/>:</label><span style="color:red;">  *</span><br>
							...
							<div class="form-group col-md-10">		
								<button type="button" class="btn btn-success" onclick="select();"><s:text name="save"/></button>
							</div>
						</form>			
						</div>
					</div>
