...
<head>
	...
	<script language="javascript">
		function doLink(commuhistoryid){
		    window.location = "clientManager/clientInfoManage/commuhistoryinfo.jsp?commuhistoryid=" + commuhistoryid;
		}
	</script>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
							...
							<div class="form-group col-md-2">
								<label>操作</label>
							    <a href="clientManager/clientInfoManage/newcommuhistory.jsp">
							    <button id="newcommuhistory" class="btn btn-success"><i class="glyphicon glyphicon-plus"></i>新建</button>
						        </a>
							</div>
                        </div>
                    </div>
					...
					<div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                         <s:iterator value="client.commuhistorys" >
	                                     <tr class="tablelink" onclick="doLink(<s:property value="commuHistory_id"/>);">
	                                        <td><s:property value="commuHistory_date"/></td>
											<td><s:property value="commuHistory_location"/></td>
											<td><s:property value="commuHistory_outline"/></td>
											<td><s:property value="commuHistory_detail"/></td>
											<td><s:property value="commuHistory_memo"/></td>
	                                     </tr>
							             </s:iterator>
                                    </tbody>
                                </table>
