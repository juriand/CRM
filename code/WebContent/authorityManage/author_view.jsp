            ...
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
						...
						<ol class="breadcrumb">
							...
							<li><a href="authorityManage/author!listAll"><s:text name="authorityManagement"/></a></li>
							<li class="active"><s:text name="viewAuthor"/></li>
						</ol>
                ...
                <div class="row">
			        ...
			        <div class="panel panel-default">
						...
						<form id="authorForm" action="authorityManage/author!update" method="post">	
							<div class="form-group col-md-5">
								<label><s:text name="viewAuthor"/></label><span style="color:red;">  *</span>
								 <input id="id" name="authority_id" class="form-control" type="text" required="required" value="${ author.authority_id}" disabled="disabled"/>
							</div>
							<div class="form-group col-md-5">
								<label><s:text name="authorName"/></label><span style="color:red;">  *</span>
								<input id="name" name="authority_name" class="form-control" type="text" required="required" value="${ author.authority_name}" disabled="disabled"/>	
							</div>

						</form>
							<div class="form-group col-md-10">
								<button id="changeBtn" class="btn btn-danger" onclick="changeEditable();"><s:text name="modify"/></button>
								<button type="submit" id="submitBtn" form="authorForm" class="btn btn-success" style="display:none"><s:text name="save"/></button>
