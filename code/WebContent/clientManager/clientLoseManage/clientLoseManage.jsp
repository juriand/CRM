            ...
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
						...
						<form class="input-group" action="clientLoseManage/client!list" method="post">
							<div class="form-group col-md-4">
                                <select name="status" class="form-control">
                                    <option value="3"><s:text name="chooseStatus"/>...</option>
                                    <option value="0"><s:text name="lostWarn"/></option>
                                    <option value="1"><s:text name="suspendLost"/></option>
                                    <option value="2"><s:text name="confirmLost"/></option>
                                </select>	
                            </div>
										
                            <div class="form-group col-md-4">
                                <input name="clientName" class="form-control" type="text" placeholder="<s:text name="inputClientName"/>">
                            </div>
							
							<div class="input-group col-md-4">
                                <input name="userid" class="form-control" type="text" placeholder="<s:text name="iputClientManage"/>">
                                ...
                                <table class="table table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th><s:text name="clientManager"/></th>
											<th><s:text name="lastOrderDate"/></th>
											<th><s:text name="confirmLostDate"/></th>
                                    ...
                                    <s:iterator value="records" >
                                        <tr>
                                            <td><s:property value="lose_id"/></td>
                                            <td><s:property value="lose_client.client_name"/></td>
											<td><s:property value="lose_client.client_clientmanage.user_id"/></td>
											<td><s:property value="lose_lastorder_date"/></td>
											<td><s:property value="lose_verify_date"/></td>
											<td><s:property value="lose_status"/></td>
											
											<td>
											<s:if test="lose_status == \"0\"">
												<button class="btn btn-primary" onclick="window.location='clientLoseManage/client!prePostpone?lose_id=${lose_id}'"><s:text name="suspendLost"/></button>  
												<button class="btn btn-danger" onclick="window.location='clientLoseManage/client!preVerify?lose_id=${lose_id}'"><s:text name="confirmLost"/></button>
											</s:if>
											
											<s:if test="lose_status == \"1\"">  
												<button class="btn btn-danger" onclick="window.location='clientLoseManage/client!preVerify?lose_id=${lose_id}'"><s:text name="confirmLost"/></button>
											</s:if>
