...
<body>
    <div id="wrapper">
        ...
        <s:if test="#request.haveAddAuthor == true 
        			|| #request.haveModifyAuthor == true 
        			|| #request.haveDeleteAuthor == true 
        			|| #request.haveAssignAuthor == true">
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                    	<s:if test="#request.haveAddAuthor == true">
                        <h1 class="page-head-line"><s:text name="saleOppor"/> <a href="saleManage/oppor_add.jsp"><button id="newcommuhistory" class="btn btn-success"><i class="glyphicon glyphicon-plus"></i><s:text name="add"/></button></a></h1>
						</s:if>
						<s:else>
						<h1 class="page-head-line"><s:text name="saleOppor"/></h1>
						</s:else>
						
						<form class="input-group" action="saleManage/oppor!list" method="post">
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                    	...
                                    	<s:if test="oppors.size()!=0">
                                        	...
                                        	<tr class="tablelink" onclick="doLink('saleManage/oppor!view?oppo_id=${oppo_id}');">
												...
												<s:if test="#request.haveDeleteAuthor == true">
													<td>	
													<a href="saleManage/oppor!delete?oppo_id=${oppo_id}"><button class="btn btn-danger"><i class="glyphicon glyphicon-home"></i><s:text name="delete"/></button></a>
													</td>
												</s:if>									
                                        	</tr>
                                        	</s:iterator>
