            ...
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
						...
						<ol class="breadcrumb">
							...
							<li class="active"><s:text name="addUser"/></li>
						</ol>
                ...
                <div class="row">
			        ...
			        <div class="panel panel-default">
						...
						<form action="authorityManage/user!add" method="post">	
							<div class="form-group col-md-5">
								<label><s:text name="id"/></label><span style="color:red;">  *</span>
								 <input name="user_id" class="form-control" type="text" required="required"/>
							</div>
							<div class="form-group col-md-5">
								<label><s:text name="password"/></label><span style="color:red;">  *</span>
								<input name="user_password" class="form-control" type="text" required="required"/>	
							</div>
							<div class="form-group col-md-5">
								<label><s:text name="nickname"/></label>
								 <input name="user_nickname" class="form-control" type="text" />
							</div>

							<div class="form-group col-md-5">
								<label><s:text name="role"/></label><span style="color:red;">  *</span>
								<select name="user_role.role_id" class="form-control">
							...
							<div class="form-group col-md-10">
								<button type="submit" class="btn btn-success"><s:text name="save"/></button>
							</div>
						</form>
