                        ...
                        <div class="panel-body">
                            <form >
								<div class="form-group col-md-5">
									<label>编号</label>
                                    <input name="dictionary_id" class="form-control" type="text">
                                </div>
								<div class="form-group col-md-5">
									<label>类别</label><span style="color:red;">  *</span>
                                    <input name="dictionary_type" class="form-control" type="text" required>
                                </div>
								<div class="form-group col-md-5">
									<label>条目</label><span style="color:red;">  *</span>
                                    <input name="dictionary_entry" class="form-control" type="text" required>
                                </div>
								
								<div class="form-group col-md-5">
									<label>值</label><span style="color:red;">  *</span>
                                    <input name="dictionary_value" class="form-control" type="text" required>
                                </div>
								
								<div class="form-group col-md-4">
									        <label>是否可编辑</label>
                                            <select name="dictionary_editable" class="form-control"  >
                                                <option>请选择</option>
                                                <option>是</option>
                                                <option>否</option>
                                            </select>     
								...
								<div class="form-group col-md-10">
								     <a href="data_datamanage.html"><button class="btn btn-info"></i>保存</button></a>
									<!--<button type="submit" class="btn btn-info" >保存</button>-->
									<a href="data_datamanage.html"><button class="btn btn-danger">返回</button>
                                </div>
