                ...
                <div class="row">
                    <div class="col-md-12">
						...
						<ol class="breadcrumb">
							...
							<li class="active"><s:text name="addOpportunity"/></li>
						</ol>
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <form action="saleManage/oppor!add" method="post">
								<div class="form-group col-md-5">
									<label><s:text name="source"/></label>
                                    <input name="oppo_source" class="form-control" type="text" >
                                </div>
								<div class="form-group col-md-5">
									<label><s:text name="clientName"/></label><span style="color:red;">  *</span>
                                    <input name="oppo_clientName" class="form-control" type="text" required maxlength="20">
                                </div>
								<div class="form-group col-md-5">
									<label><s:text name="probability"/>（%）</label><span style="color:red;">  *</span>
                                    <input name="oppo_probability" class="form-control" type="text" required pattern="[0-9]{1,2}" maxlength="3">
                                </div>
								<div class="form-group col-md-10">
									<label><s:text name="clientOutline"/></label><span style="color:red;">  *</span>
                                    <input name="oppo_outline" class="form-control" type="text" required maxlength="20">
                                </div>
								<div class="form-group col-md-4">
									<label><s:text name="clientContact"/></label>
                                    <input name="oppo_contact" class="form-control" type="text" maxlength="5">
                                </div>
								<div class="form-group col-md-4">
									<label><s:text name="clientConPhone"/></label>
                                    <input name="oppo_contactPhone" class="form-control" type="tel" maxlength="11">
                                </div>
								<div class="form-group col-md-10">
									<label><s:text name="descrip"/></label><span style="color:red;">  *</span>
                                    <textarea name="oppo_content" class="form-control" rows="3" required maxlength="100"></textarea>
                                </div>
								<div class="form-group col-md-5">
									<label><s:text name="creator"/></label><span style="color:red;">  *</span>
                                    <input class="form-control" type="text" value="${ sessionScope.user.user_id}" disabled="disabled" maxlength="5">
                                </div>
								<div class="form-group col-md-5">
									<label><s:text name="createTime"/></label><span style="color:red;">  *</span>
                                    <input class="form-control" type="text" value="<%= df.format(new Date()) %>" disabled="">
                                </div>
								<div class="form-group col-md-5">
								...
								<div class="form-group col-md-10">									
									<button type="submit" class="btn btn-info"><s:text name="save"/></button>
									<button class="btn btn-danger"><s:text name="back"/></button>
                                </div>
