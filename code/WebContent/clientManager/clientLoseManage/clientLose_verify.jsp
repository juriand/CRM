                ...
                <div class="row">
                    <div class="col-md-12">
						...
						<ol class="breadcrumb">
							...
							<li class="active"><s:text name="confirmLost"/></li>
                        </ol>
            ...
            <div class="col-xs-12">
               <div class="panel panel-default">
                        <div class="panel-body">
                            <form action="clientLoseManage/client!verify" method="post">
										...
										<div class="form-group col-md-10">
                                            <label><s:text name="lostReason"/></label><span style="color:red;">  *</span>
                                            <s:if test="lose_status == \"2\"">
                                            <textarea name="lose_reason" class="form-control" rows="3" readonly="readonly">${record.lose_reason }</textarea>
                                            </s:if>
                                            <s:else>
                                            <textarea name="lose_reason" class="form-control" rows="3" required="required" ></textarea>
                                            </s:else>
                                        </div>
                                        <div class="form-group col-md-10">
