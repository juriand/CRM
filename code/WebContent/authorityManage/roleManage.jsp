    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line"><s:text name="roleManagement"/>  <a href="authorityManage/role!prepareAdd"><button class="btn btn-success"><i class="glyphicon glyphicon-plus"></i><s:text name="add"/></button></a></h1>
                            <ol class="breadcrumb">
							  <li><s:text name="authorityManagement"/></li>
							  <li class="active"><s:text name="roleManagement"/></li>
							</ol>	
						</h1>
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <s:if test="roles.size()!=0">
                                        	...
                                        	<tr class="tablelink" onclick="doLink('authorityManage/role!view?role_id=${role_id}');">
                                            	<td><s:property value="role_id"/></td>
                                            	<td><s:property value="role_name"/></td>
												<td>
													<a href="authorityManage/role!delete?role_id=${role_id}"><button class="btn btn-danger"><s:text name="delete"/></button></a>
												</td>
                                        	</tr>
                                        	</s:iterator>
                                        </s:if>
