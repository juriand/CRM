                    ...
                    <li>
                        <a class="active-menu-top" href="#"><i class="fa fa-bicycle "></i>服务管理<span class="fa arrow"></span></a>
                         <ul class="nav nav-second-level collapse in">
							...
							<li>
                                <a class="active-menu" href="<%=basePath%>serviceManage/service!loadAllToServiceArchived"><i class="fa fa-code "></i>服务归档</a>
                            </li>
                        ...
                        <s:if test="ser!=null">
                            <form role="form">
                                        <div class="form-group col-md-5">
                                            <label>服务编号</label>
                                            <input class="form-control" type="text" value="${ser.service_id}" readonly>
                                        </div>
                                        <div class="form-group col-md-5">
                                            <label>服务类型</label>
                                            <input class="form-control" type="text" value="${ser.service_type.dictionary_value}" readonly>
                                        </div>
                                        <div class="form-group col-md-10">
                                            <label>概要</label>
                                            <input class="form-control" rows="3" readonly value="${ser.service_outline}">
                                        </div>
                                        <div class="form-group col-md-5">
                                            <label>客户名称</label>
                                            <input class="form-control" type="text" value="${ser.service_client}" readonly>
                                        </div>
										<div class="form-group col-md-5">
                                            <label>服务状态</label>
                                            <input class="form-control" type="text" value="${ser.service_status}" readonly>
                                        </div>
										<div class="form-group col-md-10">
                                            <label>服务请求</label>
                                            <textarea class="form-control" rows="3" readonly>${ser.service_request}</textarea>
                                        </div>
										<div class="form-group col-md-5">
                                            <label>创建人</label>
                                            <input class="form-control" type="text" value="${ser.service_creator.user_id}" readonly>
                                        </div>
										<div class="form-group col-md-5">
                                            <label>创建时间</label>
                                            <input class="form-control" type="text" value="${ser.service_create_date}" readonly>
                                        </div>
										<div class="form-group col-md-5">
                                            <label>分配给</label>
                                            <input class="form-control" type="text" value="${ser.service_clientManager.user_id}" readonly>
                                        </div>
										<div class="form-group col-md-5">
                                            <label>分配时间</label>
                                            <input class="form-control" type="text" value="${ser.service_assign_date}" readonly>
                                        </div>
										<div class="form-group col-md-10">
                                            <label>服务处理</label>
                                            <textarea class="form-control" rows="3" readonly>${ser.service_handling}</textarea>
                                        </div>
										<div class="form-group col-md-5">
                                            <label>处理人</label>
                                            <input class="form-control" type="text" value="${ser.service_conductor.user_id}" readonly>
                                        </div>
										<div class="form-group col-md-5">
                                            <label>处理时间</label>
                                            <input class="form-control" type="text" value="${ser.service_handling_date}" readonly>
                                        </div>
										<div class="form-group col-md-5">
                                            <label>处理结果</label>
                                            <input class="form-control" type="text" value="${ser.service_handling_result}" readonly>
										</div>
                                        ...
                                        <div class="form-group col-md-10">
										<a href="serviceManage/service!loadAllToServiceArchived"><button type="button" class="btn btn-danger">返回</button></a>
                                        </div>
