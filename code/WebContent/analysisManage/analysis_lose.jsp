    ...
    <div id="wrapper">
                        ...
                        <a  class="active-menu-top" href="#"><i class="fa fa-bicycle "></i><s:text name="dataAnalysis"/><span class="fa arrow"></span></a>
                         <ul class="nav nav-second-level collapse in">
							...
							<li>
                             ...
                             <li>
                                <a class="active-menu" href="analysisManage/analysis!lose"><i class="fa fa-code "></i><s:text name="clientLostAna"/></a>
                            </li>
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line"><s:text name="clientLostAna"/></h1>
						
						<form action="analysisManage/analysis!lose">
							<div class="form-group col-md-5">
								<input name="clientName" type="text" class="form-control" placeholder="<s:text name="inputClientName"/>"/>
                        	</div>
							
							<div class="input-group col-md-5">
								<input name="clientManager" type="text" class="form-control" placeholder="<s:text name="iputClientManage"/>"/>
                                ...
                                <table class="table table-hover">
                                    <thead>
                                        <tr>
											...
											<th><s:text name="clientManage"/></th>
                                            <th><s:text name="lostReason"/></th>
                                        </tr>
                                    </thead>
                                    ...
                                    <s:iterator value="records">
                                        <tr>
											...
											<td><s:property value="lose_reason"/></td>
                                        </tr>
                                    </s:iterator>
                                    </s:if>
                                    <s:else>
