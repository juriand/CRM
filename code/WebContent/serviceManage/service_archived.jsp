    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                ...
                <!-- /. ROW  -->
            <s:if test="#request.haveArchivedAuthor == true">
            <div class="row">
            <div class="col-xs-12">
               <div class="panel panel-default">
                        <div class="panel-body">
                             <form role="form" action="serviceManage/service!listArchived" method="post">
                                      ...
                                      <s:if test="services.size()==0">
                                         ...
                                         <s:if test="services.size()!=0">
                                        	...
                                        	<tr class="tablelink">
												...
												<td><s:property value="service_status"/></td>
											<td><a href="serviceManage/service!ArchivedService?service_id=${service_id}"><button type="button" class="btn btn-warning">查看</button></a></td>
                                        	</tr>
                                        	</s:iterator>
                                        </s:if>
                                    </tbody>
