...
<body>
                    ...
                    <li>
                        <a class="active-menu-top" href="#"><i class="fa fa-bicycle "></i>服务管理<span class="fa arrow"></span></a>
                         <ul class="nav nav-second-level collapse in">
							...
							<li>
                                <a class="active-menu" href="<%=basePath%>serviceManage/service!loadAllToServiceDeal"><i class="fa fa-code "></i>服务处理</a>
                            </li>
							<li>
         ...
         <div id="page-wrapper">
            ...
            <div class="col-xs-12">
               <div class="panel panel-default">
                        ...
                        <s:if test="ser!=null">
                            <form role="form" action="serviceManage/service!updateDealedService" method="post">
										...
										<div class="form-group col-md-10">
                                            <label>服务处理</label><span style="color:red;">  *</span>
                                            <textarea name="service_handling" class="form-control" rows="3" id="serviceHandling"  disabled="">${ser.service_handling}</textarea>
                                        </div>
										<div class="form-group col-md-5">
                                            <label>处理人</label><span style="color:red;">  *</span>
                                            <input name="service_conductor.user_id" class="form-control" type="text" value="<%=user.getUser_id()%>" disabled="">
                                        </div>
										<div class="form-group col-md-5">
                                            <label>处理时间</label><span style="color:red;">  *</span>
                                            <input name="service_handling_date" class="form-control" type="text" value="<%= df.format(new Date()) %>" disabled="">
                                        </div>
                                        <div class="form-group col-md-10">
										...
										<a href="serviceManage/service!loadAllToServiceDeal"><button type="button" class="btn btn-danger">返回</button></a>
                                        </div>
    ...
    function check(){
    	var serviceHandling = document.getElementById("serviceHandling").value;
    	if (serviceHandling.length == 0){
    		alert("请填写服务处理！");
    		return false;
    	}
    	return true;	
    ...
    function changeEditable(){
	    document.getElementById("serviceHandling").disabled=false;
