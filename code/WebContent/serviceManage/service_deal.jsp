    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                ...
                <!-- /. ROW  -->
            <s:if test="#request.haveDealAuthor == true">
            <div class="row">
            <div class="col-xs-12">
               <div class="panel panel-default">
                        <div class="panel-body">
                         <form role="form" action="serviceManage/service!listAllocated" method="post">
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                       ...
                                       <s:if test="services.size()!=0">
											...
											<td><a href="serviceManage/service!dealService?service_id=${service_id}"><button type="button" class="btn btn-warning">处理</button></a></td>
                                        	</tr>
                                        	</s:iterator>
                                        </s:if>
                                    </tbody>
